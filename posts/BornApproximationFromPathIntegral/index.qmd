...
\end{align*}
$$
Here we've used a trick to break the propagator into two parts, which can be interpreted as the particle traveling to point $x'$ at time $t'$, interacting with $V$, then continues its propagation, just like a vertex in QFT Feynman diagrams.
